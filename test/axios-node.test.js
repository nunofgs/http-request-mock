...
// 'jsdom' will set up a fake XMLHttpRequest which triggers "http.request" for http request.
// You may need to configure Axios to use the Node adapter as in the example below:
// or, you can disable jsdom in package.json: "jest": { "testEnvironment": "node" }
